...
Terminal implementation, throw an exception. Abnormal output control please refer to: [Application Configuration] (en-us / 3-1-configuration.md)
...
The specific operation and use, please see: [service provider] (zh-cn / 3-6-service-provider.md)
...
Next section: [Service Providers] (en-us / advanced / 3-3-service-provider.md)