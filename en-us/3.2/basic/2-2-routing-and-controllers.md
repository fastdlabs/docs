...
Support `get, post, put, head, delete` method. Adding routing names makes it easier to call in [TCPServer] (en-us / 3-9-swoole-server.md)
...
> The controller does not need to inherit any object, and the methods are provided by [Accessory] (en-us / 3-7-helpers.md)
...
Next Section: [Request] (en / basic / 2-3-request-handling.md)